...
export default function Dashboard() {
  ...
  const overdueInfo = oldestOverdue
    ? `Oldest overdue: Unit ${oldestOverdue.residents?.unit_number || oldestOverdue.unitNumber || '222'} (Rs. ${Number(oldestOverdue.total_payable || oldestOverdue.total_amount || oldestOverdue.totalAmount || oldestOverdue.society_maintenance_fee || 0).toLocaleString()} · Due ${oldestOverdue.due_date || oldestOverdue.dueDate || 'Past Due'}${overdueCount > 1 ? ` · ${overdueCount} units overdue` : ''})`
    : overdueCount > 0
