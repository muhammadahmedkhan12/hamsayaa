...
export const mockAssets = [
  {
    id: 'ast-001',
    name: '250 kVA Standby Diesel Generator (Cummins)',
    category: 'Generators & Power',
    install_date: '2023-03-15',
    next_service_due: '2026-09-12',
    days_until_due: 8,
  ...
  {
    id: 'ast-002',
    name: 'Mitsubishi Passenger Elevator #1 (Block A)',
  ...
  {
    id: 'ast-003',
    name: 'Mitsubishi Passenger Elevator #2 (Block B)',
    category: 'Elevators & Lifts',
    install_date: '2022-11-20',
    next_service_due: '2026-08-28',
    days_until_due: -7,
  ...
  {
    id: 'ast-004',
    name: 'Grundfos Hydro-Pneumatic Water Booster Pump (Basement)',
    category: 'Water & Plumbing Pumps',
  ...
  {
    id: 'ast-005',
    name: 'Hikvision 64-Channel CCTV Network Video Recorder',
  ...
  {
    id: 'ast-006',
    name: 'Solar Inverter System 20kW (Roof Block A)',
    category: 'Solar & Renewable',
    install_date: '2024-04-01',
    next_service_due: '2026-10-20',
    days_until_due: 46,
    health_status: 'operational',
...
export const mockMaintenanceLogs = [
  {
    id: 'log-001',
    asset_id: 'ast-001',
    serviced_at: '2026-06-12',
    notes: 'Replaced engine oil, fuel filters, and radiator coolant. Tested under 60% building load for 45 minutes.',
    next_due_override: '2026-09-12',
    created_at: '2026-06-12T14:30:00Z',
  },
  {
    id: 'log-002',
    asset_id: 'ast-002',
    serviced_at: '2026-07-05',
    notes: 'Monthly elevator safety inspection. Lubed guide rails, tested governor brake and door sensor alignments.',
    next_due_override: '2026-10-05',
